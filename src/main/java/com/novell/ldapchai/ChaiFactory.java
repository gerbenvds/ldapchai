...
import com.novell.ldapchai.impl.opendj.entry.OpenDJEntryFactory;
...
// ------------------------------ FIELDS ------------------------------
    ...
    static {
        ...
        ENTRY_FACTORY_MAP.put(ChaiProvider.DIRECTORY_VENDOR.FORGEROCK_OPENDJ, new OpenDJEntryFactory());
